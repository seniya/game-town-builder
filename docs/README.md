...
- `proposals/`: 정본 밖에서 방향을 탐색한 제안과 시험판 기록이다. 오너가 채택하기 전까지 구현 기준이 아니다.
  2026-09-26 [살아 있는 마을 시뮬레이션 시험판](proposals/2026-09-26-world-simulation-prototype.md)(코드 `prototypes/dotori-village/`).
