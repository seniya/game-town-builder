...
10. STYLE-001 → (게이트 V1: 오너 위임, 에이전트 선택) → STYLE-005 → STYLE-004 → STYLE-002 → STYLE-003 → STYLE-007 → STYLE-006 (게이트 V2) (2026-09-25 사용자 결정 D1: [확장 로드맵](EXPANSION_ROADMAP.md) X0 부터. 명세 MVP_SPEC 45. 순서와 V1 위임은 ADR 046)
