...
검토 완료가 모든 세부 정책의 확정을 뜻하지는 않는다. 구현 전에 정해야 할 열린 항목은
[최신 검토 기록](../state/2026-09-22_2248-docs-consistency-and-direction-review.md)에
해당 Task와 함께 남긴다. 누락을 새 메커닉 도입의 근거로 삼지 않는다.
